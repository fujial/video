...
void INetMediator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        INetMediator *_t = static_cast<INetMediator *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (INetMediator::*_t)(unsigned int , char * , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&INetMediator::SIG_ReadyData)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (INetMediator::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&INetMediator::SIG_disConnect)) {
                *result = 1;
                return;
            }
        }
