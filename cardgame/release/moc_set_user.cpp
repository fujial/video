...
QT_MOC_LITERAL(5, 40, 19), // "on_pb_clear_clicked"
QT_MOC_LITERAL(6, 60, 18), // "on_pb_emit_clicked"
QT_MOC_LITERAL(7, 79, 12), // "slot_setInfo"
QT_MOC_LITERAL(8, 92, 6) // "iconid"

    },
    "set_user\0SIG_Setuser_Commit\0\0conid\0"
    "name\0on_pb_clear_clicked\0on_pb_emit_clicked\0"
    "slot_setInfo\0iconid"
};
...
static const uint qt_meta_data_set_user[] = {
 ...
 // slots: parameters
    QMetaType::Void,
    QMetaType::Void,
    QMetaType::Void, QMetaType::Int, QMetaType::QString,    8,    4,
...
void set_user::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SIG_Setuser_Commit((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->on_pb_clear_clicked(); break;
        case 2: _t->on_pb_emit_clicked(); break;
        case 3: _t->slot_setInfo((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (set_user::*_t)(int , QString );
...
// SIGNAL 0
void set_user::SIG_Setuser_Commit(int _t1, QString _t2)
{
